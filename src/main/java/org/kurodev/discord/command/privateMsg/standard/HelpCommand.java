package org.kurodev.discord.command.privateMsg.standard;
...
import org.kurodev.discord.command.privateMsg.PrivateCommand;
...
public class HelpCommand extends PrivateCommand {
    ...
    public void prepare() throws Exception {
        response = HelpTextFormatter.format(commands, true, false);
    }
